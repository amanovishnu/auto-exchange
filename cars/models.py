...
class Car(models.Model):
    ...
    body_style = models.CharField(
        max_length=255, choices=body_style_choices, default="Super Car"
    )
    engine = models.CharField(
        max_length=255,
        choices=engine_choices,
        default="Audi Turbocharged 2.5-Liter Inline-Five",
    )
    transmission = models.CharField(
        max_length=255, choices=transmission_choices, default="Manual"
    )
    interior = models.CharField(max_length=255)
    miles = models.IntegerField(default=50000)
    ...
    mileage = models.IntegerField(default=15)
